...
module.exports = {
    ...
    // add your Session Id make sure it starts with LELOUCH~
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY LELOUCH XD 😆*",
...
ᴋᴇᴇᴘ ᴜsɪɴɢ ✦LELOUCH-MD✦ ғʀᴏᴍ ᴍickey ᴛᴇᴄʜ ɪɴᴄ⚡
...
> ɢɪᴛʜᴜʙ : https://github.com/Mickey-Lelouch/LELOUCH-MD`,
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2376568XXXX",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "LELOUCH",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ LELOUCH *",
    ...
    DEV: process.env.DEV || "237656828684",
...
`*Hᴇʟʟᴏ ᴛʜᴇʀᴇ LELOUCH-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 
